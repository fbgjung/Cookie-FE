...
| 박건휘 | Front-end <br/> 부팀장 | - BE/ FE 배포환경 구축 (EC2, RDS, MongoDB 서버, Nginx, Redis OSS 활용)<br />- 영화 검색 페이지<br />- 영화 상세 페이지<br />- 리뷰 피드 페이지<br />- 리뷰 등록 페이지<br />  - 사용자 맞춤 영화 추천<br /> - 리뷰 상세 페이지<br />- 소셜 로그인 배포단 환경 설정|
| 김의진 |     Front-end      | |
