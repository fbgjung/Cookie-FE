...
| 류금정 |      Back-end      | - DB 설계<br />- 영화 리뷰 시스템 개발<br />- 영화 매치업 시스템 개발<br />- 영화 검색 기능 개발<br />- FCM 푸쉬 알림 기능 구현<br />                                                                                                                                                                                                                                                                                                                                                                        |
| 정유진 |      Back-end      | - DB 설계<br />- 영화 상세보기<br />- 감독, 배우 정보 상세보기<br />- 메인페이지 정보 가져오기 및 캐시 적용<br />- 배치 사용하여 장르 점수 업데이트 로직 구현<br />  - 사용자 맞춤 영화 추천|
| 박건휘 | Front-end <br/> 부팀장 | - BE/ FE 배포환경 구축 (EC2, RDS, MongoDB 서버, Nginx, Redis OSS 활용)<br />- 영화 검색 페이지<br />- 영화 상세 페이지<br />- 리뷰 피드 페이지<br />- 리뷰 등록 페이지<br />  - 리뷰 상세 페이지<br />- 소셜 로그인 배포단 환경 설정|
| 김의진 |     Front-end      | | - 초기 세팅 및 반응형 UI 구축 (태블릿, 모바일 대응)<br />- Zustand를 활용한 전역 상태 관리 (사용자 정보, 알림 상태 등)<br />- 마이페이지 UI 구현 (프로필 이미지 수정, 대표 뱃지 관리, 닉네임 수정, 좋아하는 장르 수정 기능)<br />- 좋아한 리뷰 및 영화 페이지 UI 구성 (스크롤 페이징, 리뷰 상세보기, 영화 상세보기 기능 포함)<br />- 매치업 페이지 UI 설계 및 투표 기능 구현 (매력 포인트, 감정 포인트)<br />- 실시간 채팅 기능 구현 (STOMP 사용)<br />- 알림 수신 및 관리 인터페이스 구현<br />- 포인트 내역 UI 구성 (사용/적립 내역 조회 화면 설계)<br />- 전체적인 UI/UX 리팩토링 및 반응형 개선 작업 |
| 임가인 |     Front-end       | - 로그인 페이지<br />- 회원가입 페이지<br />- 메인 페이지<br />- 관리자 영화 등록 페이지<br />- 관리자 리뷰 좋아요 관리페이지<br />- 관리자 매치업 관리 페이지 <br />- 관리자 배지 관리 페이지
<br />
