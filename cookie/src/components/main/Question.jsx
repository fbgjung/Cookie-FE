...
const Question = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer:
        "맞춤형 영화 제공 데이터가 없을때, 회원가입 시 선택한 장르의 영화를 보여드려요. \n해당 장르의 영화에 리뷰가 달리면 푸쉬알림으로 소식을 받아보실 수 있어요.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "월 ~ 일요일 자정까지 한 회차마다 1개의 매치업이 진행됩니다. \n하나의 영화에 투표하고, 채팅으로 이야기를 나누어 보세요! 우승작에 투표한 모든 사용자에게 포인트를 드려요.",
    },
  ];
