...
const Question = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer:
        "사용자의 다양한 서비스 활동을 기반으로 선정 되는 영화로 매일 새로운 맞춤 영화를 추천받을 수 있어요!",
    },
    {
    ...
    },
    {
      ...
      answer:
        "매치업 참여, 리뷰 작성 등 활동을 통해 포인트를 획득할 수 있어요! 일정 포인트 이상 모으면 뱃지가 부여되고 단계별로 업그레이드 된답니다.",
    },
    {
      question: "매치업 참여 방식을 알려주세요?",
      answer:
        "월 ~ 일요일 자정까지 한 회차마다 1개의 매치업이 진행됩니다. 하나의 영화에 투표하고, 채팅으로 이야기를 나누어 보세요! 우승작에 투표한 모든 사용자에게 포인트를 드려요.",
    },
  ];
